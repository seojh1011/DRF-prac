# Generated by Django 4.0.5 on 2022-06-10 08:11
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('name', models.CharField(max_length=10, verbose_name='국적')),
            ],
        ),
        migrations.CreateModel(
            name='Server',
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('name', models.CharField(max_length=10, verbose_name='서버')),
            ],
        ),
        migrations.CreateModel(
            name='UserProfile',
            fields=[
                ...
                ('nationality', models.ManyToManyField(to='user.nationality', verbose_name='국적')),
                ('server', models.ManyToManyField(to='user.server', verbose_name='서버')),
            ],
        ),
    ]
